...
public class Usuario {
    ...
    // Construtor que recebe nome, email e conjunto de redes sociais do usuário.
    public Usuario(String nome, String email, HashSet<RedeSocial> redesSociais) {
        this.nome = nome; // Define o nome do usuário
        this.email = email;
        this.redesSociais = redesSociais; // Inicializa o conjunto de redes sociais com o parâmetro recebido
    }
